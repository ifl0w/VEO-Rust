...
use crate::rendering::{GPUMesh, MeshGenerator, MeshID, ResourceManager, Vertex, RenderSystem};
...
impl MeshGenerator for AABB {
    fn get_vertices_dynamic(&self) -> Vec<Vertex> {
        vec![
            Vertex::new([self.min.x, self.min.y, self.min.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
            Vertex::new([self.min.x, self.min.y, self.max.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
            Vertex::new([self.min.x, self.max.y, self.min.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
            Vertex::new([self.min.x, self.max.y, self.max.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
            Vertex::new([self.max.x, self.min.y, self.min.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
            Vertex::new([self.max.x, self.max.y, self.min.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
            Vertex::new([self.max.x, self.min.y, self.max.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
            Vertex::new([self.max.x, self.max.y, self.max.z], [0.0, 0.0, 0.0], [1.0, 1.0, 1.0]),
        ]
    }
